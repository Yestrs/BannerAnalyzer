...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-900">
        ...
        <div class="flex px-4 py-3 text-white bg-gray-900 my-8 mx-16 flex-col items-center rounded-xl">
            ...
            <form class="w-8/12 my-4" type="POST" action="/results">
                ...
                <div class="relative">
                    ...
                    <button onclick="showLoading();" id="submit_button" type="submit"
            ...
            <div style="display:none;" id="form_submited">
    ...
    <script>
        ...
        function showLoading() {
            var urlField = document.getElementById("default-search");
            if (isValidUrl(urlField.value)) {
                document.getElementById('form_submited').style.display = 'block';
            }
        }
    </script>
