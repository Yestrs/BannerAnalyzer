...
<head>
    ...
    <title>Banner Analyzer - Leaderboard</title>
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col items-center mt-6 ml-16 mr-16 text-white">
        ...
        <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-3 gap-4">
                ...
                <a href="#"
                    class="block text-center -translate-y-4 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">TOP 2</h5>
                    <h6 class="mb-2 text-1xl font-bold tracking-tight text-gray-800 dark:text-white">Points -
                        {{ $obj->top_3[1]['data']->points }}</h6>
                    <p class="font-normal text-gray-700 dark:text-gray-400">{{ $obj->top_3[1]['data']->name }}</p>
                </a>
                <a href="#"
                    class="block text-center -translate-y-8 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">TOP 1</h5>
                    <h6 class="mb-2 text-1xl font-bold tracking-tight text-gray-800 dark:text-white">Points -
                        {{ $obj->top_3[0]['data']->points }}</h6>
                                    ...
                                    <div>
                                        @if ($website['data'])
                                            <a id="showWesbiteResultsFromId"
                                                href="{{ route('p_results', ['id' => $website['data']->id]) }}"
