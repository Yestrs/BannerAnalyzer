                            ...
                            <tbody>
                                @foreach ($logs as $log)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">{{ $log->user_made_by->username }}</td>
                                        ...
                                        @else
                                        <td class="px-6 py-4"><a href="#" class="font-medium text-green-600 dark:text-green-500 hover:underline">Show</a></td>
                                        @endempty <!-- Jasafixo šis empty tā ka tas sataisīts a_users -->
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
